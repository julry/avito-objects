            ...
            <Wrapper>
                ...
                <TextWrapper>
                    <TextMd>
                        ...
                        <TextDivider />
                        Сегодня тебе предстоит почувствовать себя сотрудником Авито и{'\u00A0'}погрузиться в{'\u00A0'}работу
                        отдела продаж. Приготовься — тебе нужно будет выполнить важное задание и{'\u00A0'}придумать, 
                        как сделать товары одного 
                        из{'\u00A0'}наших клиентов <UnderlinedText color={'blue'}>более популярными.</UnderlinedText> Подключай 
                        свои навыки ведения переговоров,задавай правильные вопросы и{'\u00A0'}развивай бизнес!
                        <TextDivider />
