...
export const Location1 = ({ onStart }) => {
  ...
  return (
    <Wrapper
      $isHideAdditional={isShowObjects}
      $isShowMonitor={clicked === "email" && !isSawEmail}
    >
      {isStartPopup && (
        <LocationStart
          text={"Место силы"}
      ...
      {clicked === "gosha" && (
        <PersonInteraction onClose={handleClose} sex={sex} />
      )}
      {clicked === "email" &&
        (isSawEmail ? (
