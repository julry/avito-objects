...
export const Location2 = () => {
  ...
  const isHideAdditional = useMemo(
    () => isStartPopup || isAllPicked,
    [isStartPopup, isAllPicked]
  );
  ...
  return (
    ...
    >
      ...
      {clicked === "poster" && <PosterInteraction onClose={handleClose} />}
      {clicked === "note" && <NoteInteraction onClose={handleClose} />}
      {clicked === "folder" && <FolderInteraction onClose={handleClose} />}
      {clicked === "people" && <PeopleInteraction onClose={handleClose} />}
      {isAllPicked && <PhoneInteraction />}
    </Wrapper>
  );
};
