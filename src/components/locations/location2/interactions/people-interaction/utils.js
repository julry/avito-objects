...
export const getPeopleInteractionMessages = (sex) => [
  {
    ...
    color: "green",
    text:
      "У меня сразу после мастер-класса назначен созвон с\u00A0клиентом. " +
  ...
  },
  {
    ...
    color: "green",
    text:
      "Привет! Я тут рассказываю коллеге про одного своего клиента. " +
      `Кстати, ты знал${
        sex === SEX_TYPES.female ? "а" : ""
      }, что у\u00A0нас все клиенты ` +
...
export const getPeopleInteractionAnswerMessages = (sex) => [
  ...
  },
  {
    ...
    color: "green",
    text:
      "Пять категорий — это товары, недвижимость, авто, услуги и\u00A0работа. " +
