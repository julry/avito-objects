...
export const getPeopleInteractionMessages = () => [
    {
        id: 'loc3_person0',
        avatar: vanya,
        text: 'Классный был мастер-класс. Я сейчас занимаюсь ювелиркой, ' +
    ...
    },
    {
        id: 'loc3_person2',
        avatar: intern,
        text: 'Я работаю с магазином телефонов «Телефонотека». ' +
...
export const getAnswerMessages = (question, sex) => [
    {
        id: 'loc3_person4',
        text: `Я сегодня начал${sex === SEX_TYPES.female ? 'а' : ''} работать с\u00A0«Дивными диванами». ` +
    ...
    },
    {
        id: 'loc2_person5',
        avatar: kolya,
        text: question === '1' ? 'Удачи тебе! Уверен, все получится!'
